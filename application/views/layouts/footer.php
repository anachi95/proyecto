        <footer class="main-footer">
            ...
            <strong>Copyright &copy; <?php echo date('Y'); ?> <a href="#">Heinichen Corporation</a>.</strong> Todos los derechos reservados.
        </footer>
    </div>
    <!-- ./wrapper -->
<!-- jQuery 3 -->
...
<!--para Imprimir-->
<script src="<?php echo base_url(); ?>assets/template/jqueryprint/jquery.print.js"></script>
<!-- Bootstrap 3.3.7 -->
...
function graficar(meses,montos,year){
    ...
    title: {
        text: 'Monto de ventas por meses'
    },
    subtitle: {
        text: 'Año:' + year
    },
    ...
    tooltip: {
        ...
        pointFormat: '<tr><td style="color:{series.color};padding:0">Monto: </td>' +
            '<td style="padding:0"><b>{point.y:.0f} guaranies</b></td></tr>',
        footerFormat: '</table>',
        shared: true,
        useHTML: true
    },
